...
exports.DataGridTable = function (props) {
    ...
    return (React.createElement(Table_1.default, { "data-testid": "data-grid-table" },
        React.createElement(TableHead_1.default, null,
            React.createElement(GridHeader_1.GridHeader, { detailComponent: props.detailComponent, tbTableInstance: props.tbTableInstance })),
        React.createElement(GridBody_1.GridBody, { tbTableInstance: props.tbTableInstance, rowComponent: props.rowComponent, onRowClick: props.onRowClick, detailComponent: props.detailComponent }),
