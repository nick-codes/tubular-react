...
var getFilterControl = function (column, onEnter) {
    switch (column.dataType) {
        case tubular_common_1.ColumnDataType.Numeric:
            return React.createElement(NumericFilter_1.NumericFilter, { column: column, onApply: onEnter });
        case tubular_common_1.ColumnDataType.String:
            return React.createElement(StringFilter_1.StringFilter, { column: column, onEnter: onEnter });
        ...
        case tubular_common_1.ColumnDataType.DateTimeUtc:
            return React.createElement(DateFilter_1.DateFilter, { column: column, onApply: onEnter });
        default:
            return null;
    }
};
exports.StandardFilterEditor = function (_a) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(Grid_1.default, { container: true, spacing: 2 },
            ...
            React.createElement(Grid_1.default, { item: true, xs: 9 }, getFilterControl(column, null))),
