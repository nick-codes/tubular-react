...
exports.handleFilterChange = function (column) { return function (event) {
    column.filterText = event.target.value;
}; };
exports.onKeyDown = function (onEnter) { return function (ev) {
    if (ev.keyCode === 13) {
        ev.preventDefault();
        ev.stopPropagation();
        onEnter();
...
exports.getOperatorText = function (value, title) {
    switch (value) {
