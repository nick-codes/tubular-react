...
var getInitialDates = function (column) {
    ...
    var toDate = Date.parse(column.filterArgument && column.filterArgument[0] ? column.filterArgument[0] : null);
    if (!isNaN(startDate)) {
        dates[1] = new Date(toDate);
    }
    return dates;
};
exports.DateFilter = function (_a) {
    ...
    return (React.createElement(pickers_1.LocalizationProvider, { dateAdapter: date_fns_1.default },
        React.createElement(Grid_1.default, { container: true, direction: "column" },
            React.createElement(Grid_1.default, { item: true },
                React.createElement(pickers_1.DatePicker, { autoOk: true, clearable: true, label: isBetween ? 'From' : 'Select a date', value: dates[0], onChange: handleDateChange(), renderInput: function (props) { return React.createElement(core_1.TextField, __assign({}, props)); } })),
            column.filterOperator === tubular_common_1.CompareOperators.Between && (React.createElement(Grid_1.default, { item: true },
                React.createElement(pickers_1.DatePicker, { autoOk: true, clearable: true, label: "To", value: dates[1], onChange: handleDateChange(true), renderInput: function (props) { return React.createElement(core_1.TextField, __assign({}, props)); } }))))));
};
